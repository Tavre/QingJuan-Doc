...
## v2.2.0 为什么还不能在 Releases 下载？

截至 2026-09-11，`2.2.0+42` 仍是发布候选，GitHub 尚无 `v2.2.0` 正式 Release。源码版本号或发布 PR 不等于正式发布；需要等待主分支 CI 通过，并确认 Windows ZIP、Windows 安装 EXE、Android APK 与三份 SHA-256 全部上传。
