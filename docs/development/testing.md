...
`2.1.1+41` 修复 Android 真实路由的文字样式继承、加载语义与窄屏操作布局。`2.2.0+42` 发布 PR 当前记录为 403 项 Flutter、568 项 Python 和 62 项管理界面测试通过；最终发布仍须验证六个 Release 资产、Windows 安装器、在线更新及 Android 扫码连接 PC。
