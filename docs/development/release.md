...
Git 标签和公开版本省略构建号：`v2.0.2`。标签中的语义版本必须与 `pubspec.yaml` 一致。
...
当前已发布版本是 [`v2.0.2`](https://github.com/qingscroll/QingJuan/releases/tag/v2.0.2)，版本号为 `2.0.2+34`。Release 不是草稿或预发布；PR 质量门禁和标签发布工作流均已成功，Windows x64 ZIP、Android APK 与两份 SHA-256 资产已经上传。
