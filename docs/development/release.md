...
Git 标签和公开版本省略构建号：`v1.7.4`。标签中的语义版本必须与 `pubspec.yaml` 一致。
...
当前已发布版本是 [`v1.7.4`](https://github.com/qingscroll/QingJuan/releases/tag/v1.7.4)，版本号为 `1.7.4+25`。标签发布工作流已成功，Windows x64 ZIP、Android APK 与两份 SHA-256 资产均已上传；Release 不是草稿或预发布。
