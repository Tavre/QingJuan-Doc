...
- `QingJuan-v2.0.2-windows-x64.zip`
- 对应的 `.sha256` 校验文件

当前正式版是 [v2.0.2](https://github.com/qingscroll/QingJuan/releases/tag/v2.0.2)。Windows 与 Android 安装包及对应校验文件由正式发布工作流生成。
...
安装脚本会寻找 Tailscale、WireGuard 或局域网 IPv4，并显示管理界面地址、FastAPI 根地址、连接 Token 和首次管理密码。不要公开这些凭据。v2.0.2 还会配置多用户和受控在线升级所需服务。
...
- Android：安装 `QingJuan-v2.0.2-android.apk`。
